## kdl_parser (jazzy) - 2.11.0-4

The packages in the `kdl_parser` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy kdl_parser --override-release-repository-push-url git@github.com:revyos-ros/kdl_parser-release.git` on `Sat, 15 Jun 2024 16:47:17 -0000`
...
- release repository: https://github.com/revyos-ros/kdl_parser-release.git
- rosdistro version: `2.11.0-3`
- old version: `2.11.0-3`
- new version: `2.11.0-4`
